![api](https://github.com/user-attachments/assets/91b31172-c4c9-4a09-afcf-adad8154f76d)<h1 align="center">Hi 👋, I'm Oussama</h1>
...
# 📊 GitHub Stats:![Uploadin
      ...
      >
        <title id="titleId">Oussama Ben Saied's GitHub Stats, Rank: B-</title>
        <desc id="descId">Total Stars Earned: 98, Total Commits  : 281, Total PRs: 35, Total Issues: 0, Contributed to (last year): 1</desc>
        <style>
          .header {
    ...
    .stat {
      font: 600 14px 'Segoe UI', Ubuntu, "Helvetica Neue", Sans-Serif; fill: #68b587;
    }
    @supports(-moz-appearance: auto) {
      /* Selector detects Firefox */
      .stat { font-size:12px; }
    ...
    .rank-text {
      font: 800 24px 'Segoe UI', Ubuntu, Sans-Serif; fill: #68b587;
    ...
    @keyframes rankAnimation {
      ...
      to {
        stroke-dashoffset: 164.28662764178154;
      }
    }
      ...
      <text
        ...
        class="header"
        data-testid="header"
      >Oussama Ben Saied's GitHub Stats</text>
    </g>
      </g>
