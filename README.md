...
# 💫 About Me:
🔭 Currently building [FlexInsights](https://github.com/bensaied/FlexInsights).<br>  
...
💬 Ask me about: `React`, `Next.js`, `Node.js`, `Dash`, `ML`, `Watsonx`, `LLMs`, `Generative AI`, `n8n`, `MCP`, `A2A`, `Cryptography`,and `Docker`.<br>
